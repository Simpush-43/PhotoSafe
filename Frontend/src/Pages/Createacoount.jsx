...
const Createacoount = () => {
  ...
  const handleGoogleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      const result = await UseAuthStore.getState().handleGoogleCallback(response.data);
      if (result?.success) {
        Navigate("/home");
      }
      } catch (error) {
...
<button className="loginBtn" onClick={handleGoogleLogin} style={{backgroundColor:'white'}}>
